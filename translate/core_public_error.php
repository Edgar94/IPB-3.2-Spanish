...
'twitter_app_error'				=> "There is an error with your Twitter application settings. Please check to ensure that you have not set your Twitter application as a Desktop application type, it must be set to 'Browser'",
