...
'subject__subs_with_post'				=> "<a href='%s'>%s</a> replied to <a href='%s'>%s</a>",
'subs_with_post'				=> "<#NAME#>,
...
",
'subject__subs_new_topic'				=> "<a href='%s'>%s</a> posted topic <a href='%s'>%s</a>",
'subs_new_topic'				=> "<#NAME#>,
...
<#LINK#>
",
'subject__new_status'				=> "<a href='%s'><#OWNER#></a> has posted a new <a href='%s'>status update</a>",
'new_status'				=> "<#NAME#>,
