...
'spam_service_disabled_msg'				=> "You are entitled to the Spam Monitoring Service, but it is currently disabled. The Spam Monitoring Service helps prevent spam registrations from your community. <a href='products/spammonitor/' target='_blank'>More Information</a>.",
...
'rebuild_sphinx_config'				=> "Rebuild sphinx.conf file and cronjons",
...
'spam_service_error_msg'				=> "The last call to the Spam Monitoring Service resulted in an error. If the problem persists, you may wish to contact technical support to check your connection.",
 ); 
